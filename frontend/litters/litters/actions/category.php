...
/**
 * This is the category-action, it will display the overview of Litters categories
 *
 * @author Yohann Bianchi <sbooob@gmail.com>
 */
class FrontendLittersCategory extends FrontendBaseBlock
{
	/**
	...
	private function getData()
	{
		...
		// get category
		$this->category = FrontendLittersModel::getCategory($this->URL->getParameter(0));
		...
		// set URL and limit
		$this->pagination['url'] = FrontendNavigation::getURLForBlock('litters', 'category') . '/' . $this->category['url'];

		$this->pagination['limit'] = FrontendModel::getModuleSetting('litters', 'overview_num_items', 10);

		// populate count fields in pagination
		$this->pagination['num_items'] = FrontendLittersModel::getCategoryCount($this->category['id']);
		...
		// get items
		$this->items = FrontendLittersModel::getAllByCategory($this->category['id'], $this->pagination['limit'], $this->pagination['offset']);
	}
