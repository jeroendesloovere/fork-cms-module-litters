	...
	class BackendLittersAddParent extends BackendBaseActionAdd{
		...
		function validateForm(){
			if($this->frm->isSubmitted()){
				...
				if(!in_array($fields['affix_position']->getValue(), array('PREPEND', 'APPEND'))) $fields['affix_position']->setError(BL::err('AffixPositionIsInvalid'));
				...
				if(!in_array($fields['sex']->getValue(), array('M', 'F'))) $fields['sex']->setError(BL::err('SexIsInvalid'));
